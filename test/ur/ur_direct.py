...
# joint_q = [math.radians(20), math.radians(-177),math.radians(50), math.radians(-140), math.radians(90), math.radians(45)]
# rtde_control.moveJ(joint_q)
...
# joint_q = [math.radians(85), math.radians(-180),math.radians(50), math.radians(-140), math.radians(90), math.radians(45)]
# rtde_control.moveJ(joint_q)
